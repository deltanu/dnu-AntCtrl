...
// *** Updating the following static values, they did not seem correct.
...
static const uint16_t AS5048A_DIAG_COMP_HIGH = 0x0800;
static const uint16_t AS5048A_DIAG_COMP_LOW = 0x0400;
static const uint16_t AS5048A_DIAG_COF = 0x0200;
static const uint16_t AS5048A_DIAG_OCF = 0x0100;

static const double AS5048A_MAX_VALUE = 8191.0;
static const double AS5048A_MAX_VALUE_360 = 16383.0;
...
/**
  * Using getRawRotation() Get the rotation of the sensor relative to the zero position in degrees.
  *
  * @return {double} between 0 and 360
  */

double AS5048A::getRotationInDegrees2()
{
	uint16_t dataRotation = AS5048A::getRawRotation();
	double degrees = 360.0 * ((double)dataRotation / AS5048A_MAX_VALUE_360);
	return degrees;
}
